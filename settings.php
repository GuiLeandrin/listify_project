        ...
        <div class="h-100 w-75 bg-white">
            ...
            <div class="h-auto w-auto mt-5 ms-2 ms-md-4 ms-xxl-5">
                <div class="gap-3 d-flex mb-4">
                    ...
                    <h5 class="m-0 text-primary"><?php echo"$nome"; ?></h5>
                </div>
                <div class="gap-3 d-flex mb-4">
                    <h5 class="m-0">-</h5>
                    <i class="fa-solid fa-address-card fs-4"></i>
                    <h5 class="m-0 text-primary"><?php echo"$cpf"; ?></h5>
                </div>
                <div class="gap-3 d-flex mb-4">
                    <h5 class="m-0">-</h5>
                    <i class="fa-solid fa-phone fs-4"></i></i>
                    <h5 class="m-0 text-primary"><?php echo"$telefone"; ?></h5>
                </div>
                <div class="gap-3 d-flex mb-4 me-2">
                    <h5 class="m-0">-</h5>
                    <i class="fa-solid fa-envelope fs-4"></i>
                    <h5 class="m-0 text-primary text-truncate" title="<?php echo $email; ?>"><?php echo"$email"; ?></h5>
                </div>
                <div class="gap-3 d-flex mb-4 me-2">
                    <h5 class="m-0">-</h5>
                    <i class="fa-solid fa-lock-open fs-4"></i>
                    <h5 class="m-0 text-primary text-truncate" title="<?php echo $senha; ?>"><?php echo"$senha"; ?></h5>
                </div>
            </div>
        </div>
    </div>
